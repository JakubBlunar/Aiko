...
class GroundingContext:
    ...
    # Time-of-day (mirrors :class:`app.core.affect.circadian.CircadianState`).
    ...
    # Affect (mirrors :class:`app.core.affect.affect_state.AffectState`).
    mood_label: str | None = None

    # User-perceived state (mirrors :class:`app.core.affect.user_state.UserStateNow`).
    user_perceived_mood: str | None = None
    user_perceived_energy: str | None = None
    user_perceived_focus: str | None = None

    # World (mirrors :class:`app.core.world.world_store.WorldState`).
    world_location: str | None = None
    world_posture: str | None = None
    world_activity: str | None = None
    world_outdoor: bool = False

    # Relationship pulse (mirrors :class:`app.core.relationship.relationship.RelationshipState`).
...
def _noise_rider(level: str | None) -> str:
    ...
    Mirrors :meth:`app.core.affect.ambient_noise.AmbientNoiseTracker.prompt_block`
