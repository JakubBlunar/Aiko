...
lives in :mod:`app.core.affect.calibration_detector` (regex + cosine
...
# :class:`app.core.infra.settings.MemorySettings`.
...
class CalibrationState:
    ...
    :func:`app.core.affect.calibration_detector.apply_signal` /
    :func:`app.core.affect.calibration_detector.decay` /
    :func:`app.core.affect.calibration_detector.render_inner_life_block`.
...
class CalibrationStore:
    ...
    Mirrors :class:`app.core.persona.style_signal.StyleSignalStore`: a tiny
