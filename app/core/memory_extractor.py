...
_SYSTEM_PROMPT = (
    ...
    "companion Aiko. Your job is to extract DURABLE facts about Jacob that "
    "would still be relevant in a month: real preferences, opinions, "
    "ongoing projects, important events, relationships, recurring jokes.\n"
    "\n"
    "Rules:\n"
    "- Each memory: ONE short sentence, third person, starts with 'Jacob' "
    "  or describes him directly.\n"
    "- Skip throwaway chitchat, single-turn moods, weather, jokes, and "
    "  anything the assistant said about herself.\n"
    "- Skip anything already in the existing memory list.\n"
    "- If nothing is worth remembering, return an empty array.\n"
    "- 'kind' must be one of: fact, preference, event, relationship.\n"
