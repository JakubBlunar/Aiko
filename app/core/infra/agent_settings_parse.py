...
def parse_agent_settings(agent_raw: dict[str, Any]) -> "AgentSettings":
    ...
    return AgentSettings(
            ...
            concept_contradiction_per_hour_cap=max(
                0,
                int(agent_raw.get("concept_contradiction_per_hour_cap", 6)),
            ),
            concept_contradiction_per_day_cap=max(
                0,
            ...
            concept_consolidation_per_hour_cap=max(
                0,
                int(agent_raw.get("concept_consolidation_per_hour_cap", 6)),
            ),
            concept_consolidation_per_day_cap=max(
                0,
            ...
            shared_value_synthesis_enabled=bool(
                agent_raw.get("shared_value_synthesis_enabled", True),
            ),
            ...
            boundary_evidence_broadening_enabled=bool(
                agent_raw.get("boundary_evidence_broadening_enabled", True),
            ),
            ...
            garden_visits_enabled=bool(
                agent_raw.get("garden_visits_enabled", True),
            ),
            outings_enabled=bool(
                agent_raw.get("outings_enabled", True),
            ),
