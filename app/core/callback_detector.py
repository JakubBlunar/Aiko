...
through :class:`app.core.rag_retriever.RagRetriever`'s read-side score
...
:class:`app.core.rag_retriever.RagRetriever`.
"""
...
def _parse_iso(value: str | None) -> datetime | None:
    ...
    :func:`app.core.rag_retriever._is_faded_memory` (K7) so the two
