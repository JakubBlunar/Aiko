...
(``[[remember:...]]`` -> ``kind="self_tagged"``). A single deliberate anchor is
enough to seed a boundary; a lone cluster is not (needs >= 2). The composition
...
def _system(user_name: str, assistant_name: str) -> str:
    return (
        ...
        "detail, some notes she deliberately chose to remember, and the "
        "boundaries already known.\n\n"
        ...
        "at least two cluster rep ids in 'evidence_cluster_reps'. A lone "
        "cluster is not enough.\n"
