...
def _system(user_name: str, assistant_name: str) -> str:
    return (
        ...
        "lately while a thing he cares about has gone quiet'.\n\n"
        "Hard rules:\n"
        ...
        "other -- a value vs a contradicting behaviour, or one pattern hot "
        "while a normally-paired one has gone quiet. Two unrelated concepts "
        "are NOT a tension.\n"
