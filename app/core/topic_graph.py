...
- :class:`app.core.curiosity_seed_worker.CuriositySeedWorker` uses
...
in :func:`app.core.memory_consolidator._cluster_memories` -- same
...
from app.core.memory_consolidator import _cluster_memories
